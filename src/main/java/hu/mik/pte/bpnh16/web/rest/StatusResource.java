...
/**
 * REST controller for managing {@link hu.mik.pte.bpnh16.domain.Status}.
 */
@RestController
@RequestMapping("/api")
public class StatusResource {
     ...
     */
    @GetMapping("/statuses")
    public ResponseEntity<List<StatusDTO>> getAllStatuses(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
    ...
    public ResponseEntity<List<StatusDTO>> searchStatuses(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
