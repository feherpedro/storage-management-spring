...
export class StockTakingComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.stockTakingService
        ...
        .subscribe(
          (res: HttpResponse<IStockTaking[]>) => this.paginateStockTakings(res.body, res.headers),
  ...
  trackId(index: number, item: IStockTaking) {
    return item.id;
  }
  ...
  protected paginateStockTakings(data: IStockTaking[], headers: HttpHeaders) {
