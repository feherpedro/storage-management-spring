...
export class PriceCategoryComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.priceCategoryService
        ...
        .subscribe(
          (res: HttpResponse<IPriceCategory[]>) => this.paginatePriceCategories(res.body, res.headers),
  ...
  trackId(index: number, item: IPriceCategory) {
    return item.id;
  }
  ...
  protected paginatePriceCategories(data: IPriceCategory[], headers: HttpHeaders) {
